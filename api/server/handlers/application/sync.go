...
// ApplicationSyncHandler contains helper functions for listening to application sync requests
...
// NewApplicationSyncHandler returns a new instance of ApplicationSyncHandler
func NewApplicationSyncHandler(config *config.Config, consumer argocd.ArgoCD) ApplicationSyncHandler {
...
func (h ApplicationSyncHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	err := h.ArgoCD.Sync(r.Context(), application)
	if err != nil {
