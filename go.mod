...
replace github.com/stefanmcshane/go-argocd => ../go-argocd
...
require (
	...
	github.com/stefanmcshane/go-argocd v0.0.2 // indirect
	...
	sigs.k8s.io/aws-iam-authenticator v0.5.8 // indirect
